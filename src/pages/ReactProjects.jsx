    ...
    >
      ...
      <ScrollReveal>
        <div className="max-w-[1000px] text-lg text-slate-200 font-['Inter']">
          <p>
            After gaining a solid understanding of JavaScript, I ventured into
            using React, a powerful JavaScript framework. This section showcases
            a collection of my most significant projects written in React.
          </p>
        </div>
      </ScrollReveal>
