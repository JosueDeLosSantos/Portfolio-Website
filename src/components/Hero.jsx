      ...
      <div className="flex flex-col items-center justify-center gap-10 text-white">
        ...
        >
          ...
          <p className="md:text-base text-pretty text-sm text-slate-200">
            ...
            knack for creating intuitive user interfaces. I excel at connecting
            apps with REST APIs and have strong knowledge of SQL and NoSQL
            databases. With over two years of experience, I’m passionate about
